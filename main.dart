...
// Fotos por fila
import 'screens/planilla_photo_page.dart';
...
Future<void> _postBoot() async {
  ...
  // Prueba automática solo en debug
...
class _RootApp extends StatelessWidget {
      ...
      case '/sheet':
        {
          ...
          return _cupertino(gate(BetaSheetScreen(sheetId: pid)), settings);
        }
      case '/settings':
      ...
      case '/photos':
        {
          ...
          return _cupertino(gate(PlanillaPhotoPage(planillaId: pid, rowId: rid)), settings);
        }
      default:
  ...
  Widget build(BuildContext context) {
    // Forzado para probar export. Cambiá a '/' si querés home.
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 12),
              Text('Ocurrió un problema. Estamos trabajando en ello.'),
            ],
          ),
        ),
      );
            ...
            child: PageView(
              ...
              children: const [
                _OnbPage(
                  ...
                  title: 'Planillas rápidas',
                  body:
                  'Empezá una bitácora en segundos. Editá títulos y celdas con un toque. Todo se guarda solo.',
                ),
                _OnbPage(
                  icon: Icons.photo_camera_back_outlined,
                  title: 'Fotos + GPS',
                  body:
                  'Sacá fotos por fila y marcá ubicación precisa, incluso sin señal. Todo queda en la misma planilla.',
                ),
                _OnbPage(
                  icon: Icons.ios_share,
                  title: 'Excel a prueba de balas',
                  body:
                  'Exportá un XLSX compatible (con miniaturas y filtros) y una vista previa PNG para ver en el correo.',
                ),
                _OnbPage(
                  icon: Icons.rocket_launch_outlined,
                  title: 'Listo para trabajar',
                  body:
                  'Funciona offline, es rápido y simple. Desde Neuquén al mundo.',
                ),
              ],
            ),
          ),
